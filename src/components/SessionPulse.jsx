    ...
    >
      ...
      <div
        style={{
          ...
          height: '110px',
          borderRadius: '22px',
          background: 'linear-gradient(145deg, rgba(255, 255, 255, 0.75) 0%, rgba(248, 250, 252, 0.68) 100%)',
          border: '1.5px solid rgba(245, 130, 31, 0.38)',
          boxShadow: '0 20px 50px rgba(14, 22, 38, 0.14), 0 0 25px rgba(245, 130, 31, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.95)',
